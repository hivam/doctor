...
class doctor_attentions(osv.osv):
	...
	_columns = {
		...
		"sent_from_button" : fields.boolean('Sent from button', help="this model was called by a button."),
	}
	...
	def onchange_professional(self, cr, uid, ids, professional_id, context=None):
		...
		if not professional_id:
			return values
		professional_img = None
		professional_speciality = None
